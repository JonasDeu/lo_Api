...
router.get("/logs", auth, async (req, res) => {
	try {
		await req.user.populate("logs", "name emoji owner date numEntries lastEntry").execPopulate()
...
router.get("/logs/download", auth, async (req, res) => {
	try {
		await req.user.populate("logs", "name emoji owner date numEntries lastEntry entries").execPopulate()
